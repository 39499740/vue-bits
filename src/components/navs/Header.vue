      ...
      <div class="ln-navbar-right">
        ...
        <div class="ln-navbar-prefs-wrapper ln-navbar-lang-wrapper">
          ...
          >
            ...
            <span class="ln-navbar-lang-text">{{ currentLangLabel }}</span>
          </button>
          ...
          <Transition name="prefs">
            <div v-if="langOpen" class="ln-navbar-prefs-menu ln-navbar-lang-menu" role="menu">
              ...
              >
                ...
                <span v-else class="ln-navbar-lang-spacer" />
                {{ lang.label }}
              </button>
            </div>
          </Transition>
...
.ln-navbar-lang-active {
  color: #fff;
}

.ln-navbar-lang-spacer {
  width: 13px;
