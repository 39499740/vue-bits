      ...
      <div class="ln-footer-top">
        ...
        <nav class="ln-footer-nav">
          <div class="ln-footer-col">
            ...
            <a href="https://www.jsrepo.com/" target="_blank" rel="noopener noreferrer" class="ln-footer-link">{{ $t('footer.cli') }}</a>
          </div>

          <div class="ln-footer-col">
            <span class="ln-footer-col-title">{{ $t('footer.community') }}</span>
            <a :href="GITHUB_URL" target="_blank" rel="noopener noreferrer" class="ln-footer-link">{{ $t('footer.github') }}</a>
